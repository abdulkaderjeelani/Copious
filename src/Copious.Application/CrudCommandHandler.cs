...
namespace Copious.Application {
    ...
    where TState : class, IEntity<Guid>, new () {
        public CrudCommandHandler (ILoggerFactory loggerFactory, IExceptionHandler exceptionHandler, IRepository<TState> repository, ICommandGuard guard, IEventBus eventBus, IMapper mapper) : base (loggerFactory, exceptionHandler, repository, guard, eventBus, mapper) { }
