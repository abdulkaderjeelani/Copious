...
namespace Copious.Utilities
{
    public static class EnumExtensions
    {
        public static T Include<T>(this Enum type, T value) where T : struct
            => (T)(ValueType)(((int)(ValueType)type | (int)(ValueType)value));

        public static T Remove<T>(this Enum type, T value) where T : struct
            => (T)(ValueType)(((int)(ValueType)type & ~(int)(ValueType)value));

        public static bool Has<T>(this Enum type, T value) where T : struct
            => (((int)(ValueType)type & (int)(ValueType)value) == (int)(ValueType)value);

        public static T ToEnum<T>(this long val)
            => val.ToString().ToEnum<T>();
