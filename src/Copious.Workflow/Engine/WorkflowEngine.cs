namespace Copious.Workflow.Engine {
    ...
    public class WorkflowEngine : Component, IWorkflowEngine {
        ...
        public Task<Command> CreateCommandFromEvent (StageConnector stageConnector, Event @event) => WorkflowEvtCmdMapFinder.FindMapper (new EventToCommandMap (stageConnector.FromEvent, stageConnector.ToCommand),
