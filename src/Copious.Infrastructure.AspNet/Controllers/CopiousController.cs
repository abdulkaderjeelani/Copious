...
namespace Copious.Infrastructure.AspNet.Controllers {
    ...
    public class CopiousController : Controller {
        ...
        public CopiousController (IContextProvider contextProvider, IExceptionHandler exceptionHandler, IQueryProcessor queryProcessor, ICommandBus commandBus, ILoggerFactory loggerFactory) : this (contextProvider, exceptionHandler, loggerFactory) {
            _queryProcessor = queryProcessor;
            _commandBus = commandBus;
        }

        public CopiousController (IContextProvider contextProvider, IExceptionHandler exceptionHandler, IQueryProcessor queryProcessor, ILoggerFactory loggerFactory) : this (contextProvider, exceptionHandler, loggerFactory) {
            _queryProcessor = queryProcessor;
        }

        public CopiousController (IContextProvider contextProvider, IExceptionHandler exceptionHandler, ICommandBus commandBus, ILoggerFactory loggerFactory) : this (contextProvider, exceptionHandler, loggerFactory) {
            _commandBus = commandBus;
        }
