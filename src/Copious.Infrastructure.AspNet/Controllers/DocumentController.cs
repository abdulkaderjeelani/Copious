...
namespace Copious.Infrastructure.AspNet.Controllers
{
    ...
    public abstract class DocumentController : CopiousController
    {
        ...
        protected DocumentController(IContextProvider contextProvider, ILoggerFactory loggerFactory, IExceptionHandler exceptionHandler, IDocumentRepository documentRepository)
            : base(contextProvider, exceptionHandler, loggerFactory)
        {
